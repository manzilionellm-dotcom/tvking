...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .btn-vip{background:linear-gradient(135deg,#f7e2a0,#cda53f);color:#1a1400;font-weight:900;letter-spacing:.3px;box-shadow:0 8px 30px rgba(231,198,107,.42);border:1px solid #f7e6b0}
  .btn-vip:hover{transform:translateY(-2px);box-shadow:0 12px 48px rgba(231,198,107,.60)}
  ...
  .qr-box .qrimg svg{width:100%;height:100%;display:block}
...
<header class="nav">
  <div class="wrap nav-in">
    ...
    <a class="btn btn-vip" id="navWa">👑 Accès VIP</a>
  </div>
</header>
  ...
  <div class="wrap">
    <div class="mac-card">
      ...
      <div class="mac-input">
        ...
        <button class="btn btn-vip" id="macSend">👑 Activer mon accès</button>
      </div>
...
<section class="center">
  <div class="wrap">
    ...
    <div class="hero-cta">
      ...
      <a class="btn btn-vip" id="waBtn2">👑 Contact VIP</a>
    </div>
  </div>
</section>
...
<footer>
  <div class="wrap">
    ...
    <div class="foot-links">
      ...
      <a id="footWa" href="#">Contact VIP</a>
    </div>
...
(function(){
  ...
  // QR codes : intégrés en dur (SVG inline) — aucune dépendance externe.
