...
`com.sevenmotion.tv.seven_tv` (identité historique de 7 MOTION TV, même
package que les box déjà équipées), catégorie `LEANBACK_LAUNCHER`, et la
...
| Secret | Contenu |
|---|---|
| `ANDROID_KEYSTORE_BASE64` | le keystore 7 MOTION (`base64 -w0 release.jks`) |
...
la clé 7 MOTION : une box qui a une version signée avec la clé maîtresse
