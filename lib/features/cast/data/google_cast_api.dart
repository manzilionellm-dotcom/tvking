...
class CastNativeMediaState {
  ...
  /// Raison du passage en IDLE remontee par le recepteur :
  /// `none` | `finished` | `canceled` | `interrupted` | `error`.
  /// `error` = la TV a REFUSE le media (codec/conteneur non supporte,
  /// URL injoignable…) — distinct d'une fin normale (`finished`).
      ...
      switch (call.method) {
        case 'onMediaStateChanged':
          ...
          _mediaStateCtrl.add(CastNativeMediaState(
            ...
            idleReason: (args['idleReason'] as String?) ?? 'none',
          ));
          break;
        case 'onSessionEvent':
          final Map<Object?, Object?> args =
