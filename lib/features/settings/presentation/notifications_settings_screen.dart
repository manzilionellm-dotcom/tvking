  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          Text(
            context.l10n.settingsNotifIntro,
          ...
          _NotifSwitch(
            ...
            title: context.l10n.settingsNotifReminders,
            subtitle: context.l10n.settingsNotifRemindersSubtitle,
            value: _reminders,
            onChanged: (bool v) => _set(NotificationService.prefReminders, v),
          ),
          _NotifSwitch(
            icon: Icons.campaign_rounded,
            title: context.l10n.settingsNotifAnnouncements,
            subtitle: context.l10n.settingsNotifAnnouncementsSubtitle,
          ...
          _NotifSwitch(
            ...
            title: context.l10n.settingsNotifUpdates,
            subtitle: context.l10n.settingsNotifUpdatesSubtitle,
            value: _appUpdates,
