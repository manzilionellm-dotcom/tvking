        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(
              width: 560,
              child: Text(
                context.l10n.tvSportsEmptyHelp,
      ...
      child: Row(
        children: <Widget>[
          Container(
            ...
            child: Text(context.l10n.tvSportsTickerLabel,
