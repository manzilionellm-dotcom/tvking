...
void main() {
  ...
  testWidgets(skip: true, 'Lanceur : montage avec 30 chaînes — héro + tuiles + focus, zéro spinner',
  ...
  testWidgets(skip: true, 'Lanceur : 15 appuis D-pad sans crash ni focus perdu',
      (WidgetTester tester) async {
    await seedTvChannels();
    await pumpTvTemplate(tester, TvHomeTemplate.launcher);
    expectTvFocusAlive();
  ...
  testWidgets(skip: true, 'Lanceur : « Regarder maintenant » → faux lecteur sur la chaîne du héro, BACK revient',
      (WidgetTester tester) async {
